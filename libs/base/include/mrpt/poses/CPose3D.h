	...
	protected:
	 ...
	 public:
		...
		*/
		...
		/** Returns a human-readable textual representation of the object (e.g.: "[x y z yaw pitch roll]", angles in degrees.)
		  * \sa fromString
		  */
		...
		/** Set the current object value from a string generated by 'asString' (e.g.: "[x y z yaw pitch roll]", angles in deg. )
		  * \sa asString
